...
fun_deploy_images() {
    ...
    chmod +x ${base_dir}/*/*.sh
    chmod 777 ${base_dir}/base/volume/http/data
    chmod 777 ${base_dir}/base/volume/ftp/data
    chmod 777 ${base_dir}/base/volume/ftp/passwd
    chmod 777 ${base_dir}/base/volume/ftp/ssl
    return $re_ok
}
